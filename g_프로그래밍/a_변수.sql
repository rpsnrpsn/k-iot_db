...
# cf) SQL 변수 특징
# 1) SQL 워크벤치 시작 시 유지, 종료할 경우 사라짐 (임시 저장 공간)
# 2) SQL 비절차적 언어: 원하는 구문을 따로 실행 (변수 선언문 실행 >> 변수 출력문 실행)

-- SQL 변수 사용 예제 --
# 변수 선언
set @myVar1 = 5;
set @myVar2 = 3.14; -- @ + lowerCarmelCase
...
# excute 실행시킬 문장명 using 변수명;
# >> using 뒤에 변수값이 ? 키워드에 대입
set @count = 3;
