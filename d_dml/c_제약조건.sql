/*
    ...
    2. FK(foreign key) - 다른 테이블의 PK값을 참조하는 컬럼 (테이블 같의 연결)
...
insert into `users`
values
	(1, 'qwe123', 'qwe123123', 'qwe123@e.c', '123456');
    
-- insert into `users`
-- values
-- 	(2, 'asd123', 'asd123123', 'asd123@e.c', '456789');
    
insert into `users`
values
	(2, 'asd123', 'asd123123', null, '456789');
...
/*
	6. default 제약조건
    : 테이블의 열에 값이 입력되지 않으면 자동으로 기본값을 넣엏주는 제약 조건
