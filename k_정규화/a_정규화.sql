/*
    ...
    >> 정규화를 하지 않으면, 데이터 중복과 이상현상(삽입, 수정, 삭제 이상) 발생
    ...
    cf) 정규형(Normal Form): 데이터베이스 정규화 과정에서 달성하고자 하는 일정한 규칙이나 기준
